export const translations = {
  ...
  it: {
    ...
    seedCast: {
      ...
      heading: 'SeedCast',
      status: 'Progetto personale - SaaS self-hosted, chiavi API tue (BYOK)',
      text: 'Lead generation B2B automatizzata, costruita attorno a una metafora: chi la usa non è un utente ma un Sower, un seminatore. Sparge i semi su Google Maps, ara i siti trovati uno per uno, e riporta solo le attività che rientrano nei criteri che hai dettato - con la bozza email già scritta. Le chiavi API restano tue: SeedCast le cifra e le usa soltanto durante le tue ricerche.',
      productTitle: 'Cosa include',
      features: [
      ...
      tabSimple: 'Guida semplice',
      tabTech: 'Guida tecnica',
      simpleIntro: 'Gira sul tuo computer. Serve Docker, e due chiavi API che restano tue: una di Anthropic e una di Google Maps.',
      simpleSteps: [
        'Installa "Docker Desktop" dal sito ufficiale (gratuito) e avvialo: è il programma che fa girare i servizi sul tuo computer.',
        'Scarica il progetto ed estrailo in una cartella a tua scelta.',
        ...
        'Nella tua area personale incolla la chiave Anthropic e quella di Google Maps. Hunter.io serve solo se vuoi anche la mail del referente.',
      ...
      faq: {
        ...
        general: [
          ...
          },
          {
            ...
            a: 'Il software è self-hosted e non ha canone. Si paga solo quello che si consuma dai fornitori: in media meno di dieci centesimi per attività analizzata. Google Maps ha una quota gratuita mensile, e il tetto di spesa impedisce le sorprese.',
          },
          {
      ...
      reqTitle: 'Cosa serve',
      reqIntro: 'Gira su un computer qualsiasi, ma le chiavi dei servizi esterni restano di chi lo usa.',
      reqList: [
        'Docker (per il database e i servizi)',
        'Una chiave Anthropic, obbligatoria',
        'Una chiave Google Maps, obbligatoria',
        'Hunter.io e Firecrawl: facoltative',
      ],
      costTitle: 'Quanto si spende',
      costText: 'In media meno di dieci centesimi per attività analizzata. Ogni ricerca ha un tetto in dollari deciso da chi la lancia: raggiunto il limite l\'analisi si ferma, e la spesa si vede salire in tempo reale mentre la ricerca procede.',
      accessTitle: 'Accesso',
    ...
    home: {
      ...
      extra: {
        ...
        seedcastDesc: 'Lead generation B2B automatizzata in modalità BYOK: le chiavi API restano tue. Backend FastAPI con coda arq/Redis, frontend Next.js 16 e React 19, Supabase per database, autenticazione e Realtime. Scraping multi-pagina con Playwright, qualificazione con Claude vincolata da JSON Schema, gate umano prima di ogni analisi visiva, tetto di spesa per ricerca e consegna al CRM via webhook firmato.',
        seedcastNote: 'Repository privato, self-hosted con le proprie chiavi API.',
        soonTitle: 'Coming soon',
  ...
  en: {
    ...
    seedCast: {
      ...
      heading: 'SeedCast',
      status: 'Personal project - self-hosted SaaS, your own API keys (BYOK)',
      text: 'Automated B2B lead generation, built around a metaphor: whoever uses it is not a user but a Sower. It scatters seeds across Google Maps, ploughs through the sites it finds one by one, and brings back only the businesses that match the criteria you set - with a first email already drafted. The API keys stay yours: SeedCast encrypts them and uses them only during your own searches.',
      productTitle: 'What it includes',
      features: [
      ...
      tabSimple: 'Simple guide',
      tabTech: 'Technical guide',
      simpleIntro: 'It runs on your own machine. You need Docker, and two API keys that stay yours: one from Anthropic and one from Google Maps.',
      simpleSteps: [
        'Install "Docker Desktop" from the official site (free) and start it: it is the program that runs the services on your computer.',
        ...
        'In your personal area paste your Anthropic and Google Maps keys. Hunter.io is only needed if you also want the decision maker\'s email.',
      ...
      faq: {
        ...
        general: [
          ...
          },
          {
            ...
            a: 'The software is self-hosted and has no subscription. You only pay what you consume from the providers: on average less than ten cents per business analysed. Google Maps has a free monthly quota, and the spending cap keeps surprises out.',
          },
          {
      ...
      reqIntro: 'It runs on any machine, but the keys to the external services stay with whoever uses it.',
      reqList: [
        'Docker (for the database and the services)',
        'An Anthropic key, required',
        'A Google Maps key, required',
        'Hunter.io and Firecrawl: optional',
      ],
      costTitle: 'What it costs',
      costText: 'On average less than ten cents per business analysed. Every search carries a cap in dollars set by whoever launches it: once the limit is reached the analysis stops, and the spend is visible rising in real time as the search runs.',
      accessTitle: 'Access',
    ...
    home: {
      ...
      extra: {
        ...
        seedcastTitle: 'SeedCast',
        seedcastDesc: 'Automated B2B lead generation in BYOK mode: the API keys stay yours. FastAPI backend with an arq/Redis queue, Next.js 16 and React 19 frontend, Supabase for database, auth and Realtime. Multi-page scraping with Playwright, qualification with Claude constrained by JSON Schema, a human gate before every visual analysis, a spending cap per search and CRM delivery through a signed webhook.',
        seedcastNote: 'Private repository, self-hosted with your own API keys.',
        soonTitle: 'Coming soon',
