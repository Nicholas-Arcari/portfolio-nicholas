export const translations = {
  ...
  it: {
    ...
    cyberServices: {
      ...
      steps: [
        'Scarica il pacchetto di deploy qui sotto.',
        'Segui la guida inclusa: configura il file .env e avvia con Docker Compose.',
        'Per la chiave di licenza contattami via email indicando il tuo deployment id: te la invio in maniera sicura e tracciata.',
        'Incolla la chiave una volta nella schermata iniziale: sblocca tutta la suite.',
      ],
  ...
  en: {
    ...
    cyberServices: {
      ...
      steps: [
        'Download the deploy package below.',
        'Follow the included guide: fill in the .env file and start with Docker Compose.',
        'For the license key, email me with your deployment id: I send it to you securely and with tracking.',
        'Paste the key once on the first screen: it unlocks the whole suite.',
      ],
