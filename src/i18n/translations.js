export const translations = {
  ...
  it: {
    ...
    citizenShield: {
      ...
      installIntro: 'Il pacchetto contiene il file docker-compose, gli script di avvio, backup e ripristino per Windows, Linux e macOS, e la guida di installazione. L\'unico requisito e\' avere Docker installato.',
      installSteps: [
        'Installa Docker Desktop (Windows, macOS) oppure Docker Engine (Linux).',
        'Scarica il pacchetto qui sotto e scompattalo in una cartella a tua scelta.',
        'Apri il file .env e compila i campi vuoti: un nome per questa installazione (LICENSE_DEPLOYMENT_ID), due segreti casuali generati con openssl rand -hex 32 e una password per il database.',
        'Avvia con ./up.sh (su Windows .\\up.ps1): registra il nome citizenshield sul computer e accende i container.',
        'Apri https://citizenshield, accetta il certificato locale e incolla la chiave di licenza. Il primo utente che si registra diventa amministratore.',
      ],
      downloadBtn: 'Scarica il pacchetto di deploy',
  ...
  en: {
    ...
    citizenShield: {
      ...
      installIntro: 'The package contains the docker-compose file, the start, backup and restore scripts for Windows, Linux and macOS, and the install guide. The only requirement is having Docker installed.',
      installSteps: [
        'Install Docker Desktop (Windows, macOS) or Docker Engine (Linux).',
        'Download the package below and unpack it wherever you like.',
        'Open the .env file and fill in the empty fields: a name for this deployment (LICENSE_DEPLOYMENT_ID), two random secrets generated with openssl rand -hex 32, and a database password.',
        'Start it with ./up.sh (on Windows .\\up.ps1): it registers the citizenshield name on the machine and brings the containers up.',
        'Open https://citizenshield, accept the local certificate and paste your licence key. The first user who registers becomes the administrator.',
      ],
      downloadBtn: 'Download the deploy package',
