export const translations = {
  ...
  it: {
    ...
    home: {
      ...
      cyber: {
        ...
        soc: {
          ...
          license: 'Licenza MIT - solo per uso autorizzato, difensivo/educativo (vedi ETHICS).',
        },
        viewRepo: 'Vedi Repo',
        download: 'Scarica',
      },
    ...
    freelance: {
      ...
      securityItems: [
        'Architettura & Segmentazione IT/OT: separazione delle reti d\'ufficio e di produzione, accesso controllato ai macchinari e modello zero-trust per i moduli esposti all\'esterno.',
        'Detection & SIEM: monitoraggio attivo delle intrusioni con Wazuh e Suricata (IDS/IPS), aggregazione e correlazione dei log e alerting sulle anomalie.',
        'Secure SDLC: security scanning integrato nella pipeline (SonarQube, Trivy, Snyk), API security testing (fuzzing/RESTler), honeypot e hardening dei container secondo il principio del minimo privilegio.',
        'Identit\u00e0, Accessi & Licensing: accesso via VPN, RBAC, autenticazione robusta (Sanctum) e gestione di licenze ed entitlement tramite JWT firmati e webhook verificati via HMAC.',
        'Governance & Risk: security architecture allineata al NIST CSF (Govern, Identify, Protect, Detect, Respond, Recover), con valutazione del rischio e piani di risposta e ripristino.',
      ],
  ...
  en: {
    ...
    home: {
      ...
      cyber: {
        ...
        soc: {
          ...
          integrations: 'VirusTotal, AbuseIPDB, Shodan, URLScan.io, AlienVault OTX, MalwareBazaar, Censys, SecurityTrails.',
          license: 'MIT licensed - for authorized, defensive/educational use only (see ETHICS).',
        },
        viewRepo: 'View Repo',
        download: 'Download',
      },
    ...
    freelance: {
      ...
      securityItems: [
        'IT/OT Architecture & Segmentation: separation of office and production networks, controlled access to machinery and a zero-trust model for externally exposed modules.',
        'Detection & SIEM: active intrusion monitoring with Wazuh and Suricata (IDS/IPS), log aggregation and correlation, and anomaly alerting.',
        'Secure SDLC: security scanning integrated into the pipeline (SonarQube, Trivy, Snyk), API security testing (fuzzing/RESTler), honeypot and least-privilege container hardening.',
        'Identity, Access & Licensing: VPN access, RBAC, robust authentication (Sanctum) and management of licenses and entitlements via signed JWTs and HMAC-verified webhooks.',
        'Governance & Risk: security architecture aligned with the NIST CSF (Govern, Identify, Protect, Detect, Respond, Recover), with risk assessment and response and recovery plans.',
      ],
