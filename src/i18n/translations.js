  ...
  it: {
    ...
    cyberServices: {
      ...
      simpleSteps: [
        ...
        'Apri il browser all indirizzo http://localhost:3000 : comparira la schermata "Licenza richiesta".',
      ...
      techIntro: 'Requisiti: Docker e Docker Compose, 4 GB di RAM. Le immagini sono pubbliche: nessun login al registry.',
      techSteps: [
        ...
        'Avvia con: docker compose up -d . Scarica le 4 immagini da GHCR e parte tutto.',
        'SOC Toolkit su http://localhost:3000 , OSINT Toolkit su http://localhost:3001 . Il primo utente registrato diventa amministratore.',
      ...
      techNotes: 'Aggiornamenti: docker compose pull && docker compose up -d . Per esporla in rete, mettila dietro un reverse proxy con TLS (nginx, Traefik, Caddy). Rinnovo licenza: reincolla la nuova chiave alla scadenza, nessun dato viene perso.',
  ...
  en: {
    ...
    cyberServices: {
      ...
      simpleSteps: [
        ...
        'Open your browser at http://localhost:3000 : the "License required" screen appears.',
      ...
      techIntro: 'Requirements: Docker and Docker Compose, 4 GB RAM. The images are public: no registry login needed.',
      techSteps: [
        ...
        'Start with: docker compose up -d . It pulls the 4 images from GHCR and brings everything up.',
        'SOC Toolkit at http://localhost:3000 , OSINT Toolkit at http://localhost:3001 . The first registered user becomes admin.',
      ...
      techNotes: 'Updates: docker compose pull && docker compose up -d . To expose it on a network, put it behind a TLS reverse proxy (nginx, Traefik, Caddy). License renewal: paste the new key at expiry, no data is lost.',
