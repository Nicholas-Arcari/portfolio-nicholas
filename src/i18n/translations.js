export const translations = {
  ...
  it: {
    ...
    cyberServices: {
      ...
      licenseText: 'La chiave non è nel pacchetto. Per riceverla scrivimi via email indicando il deployment id scelto durante l’installazione: emetto la licenza dedicata al tuo deployment e te la invio in maniera sicura e tracciata.',
      ...
      ctaShieldTitle: 'Citizen Shield',
      ctaShieldDesc: 'Citizen Shield: OPSEC e difesa personale, control plane cloud + agent Docker in locale.',
  ...
  en: {
    ...
    cyberServices: {
      terminal: [
        ...
        '> Modules: [SOC Toolkit, OSINT Toolkit, Citizen Shield]',
        '> Ready to deploy.',
      ],
      heading: 'SOC Suite',
      ...
      licenseText: 'The key is not in the package. To get it, email me with the deployment id you chose during install: I issue the license bound to your deployment and send it to you securely and with tracking.',
      ...
      ctaDesc: 'SOC Suite on-premise: SOC Toolkit + OSINT Toolkit, self-hosted via Docker.',
      ctaShieldTitle: 'Citizen Shield',
      ctaShieldDesc: 'Citizen Shield: personal OPSEC and defense, cloud control plane + local Docker agent.',
      ctaBtn: 'Learn more',
    },
