export const translations = {
  ...
  it: {
    ...
    masterDetails: {
      ...
      courses: [
        { name: 'Cryptography', year: '1° anno', term: '1° semestre', cfu: '6 CFU', description: 'Fondamenti di crittografia moderna: cifrari simmetrici e asimmetrici, funzioni hash, firme digitali e protocolli di scambio delle chiavi.' },
        { name: 'Network Infrastructures', year: '1° anno', term: '1° semestre', cfu: '6 CFU', description: 'Architetture di rete, protocolli di routing e commutazione, progettazione e messa in sicurezza delle infrastrutture di comunicazione.' },
        { name: 'Distributed Systems', year: '1° anno', term: '1° semestre', cfu: '6 CFU', description: 'Sistemi distribuiti: concorrenza, consistenza, tolleranza ai guasti, algoritmi di consenso e coordinamento tra nodi.' },
        { name: 'Statistics', year: '1° anno', term: '1° semestre', cfu: '6 CFU', description: 'Metodi statistici e probabilistici applicati all\'analisi dei dati e alla valutazione quantitativa del rischio.' },
        { name: 'Elective course', year: '1° anno', term: '1° semestre', cfu: '12 CFU', description: 'Insegnamento a libera scelta, da definire nel piano di studi.' },
        { name: 'Cyber and Computer Law', year: '1° anno', term: '2° semestre', cfu: '6 CFU', description: 'Diritto dell\'informatica: protezione dei dati personali, reati informatici, prova digitale e profili di responsabilità.' },
        { name: 'Ethical Hacking', year: '1° anno', term: '2° semestre', cfu: '9 CFU', description: 'Tecniche offensive in ambiente controllato: ricognizione, sfruttamento delle vulnerabilità, post-exploitation e reportistica.' },
        { name: 'Malware Analysis and Incident Forensics', year: '2° anno', term: '1° semestre', cfu: '9 CFU', description: 'Analisi statica e dinamica del malware, risposta agli incidenti e acquisizione forense delle evidenze digitali.' },
        { name: 'Security Governance', year: '2° anno', term: '1° semestre', cfu: '6 CFU', description: 'Governo della sicurezza: gestione del rischio, standard e framework di riferimento, politiche aziendali e conformità.' },
        { name: 'Cyber Security Seminars', year: '2° anno', term: '2° semestre', cfu: '6 CFU', description: 'Ciclo di seminari su temi avanzati e casi reali, tenuti da ricercatori e professionisti del settore.' },
        { name: 'Prova Finale', year: '2° anno', term: '2° semestre', cfu: '30 CFU', description: 'Tesi di laurea magistrale: lavoro di ricerca originale, con elaborato scritto e discussione finale.' },
      ],
  ...
  en: {
    ...
    masterDetails: {
      ...
      courses: [
        { name: 'Cryptography', year: '1st year', term: '1st semester', cfu: '6 ECTS', description: 'Foundations of modern cryptography: symmetric and asymmetric ciphers, hash functions, digital signatures and key exchange protocols.' },
        { name: 'Network Infrastructures', year: '1st year', term: '1st semester', cfu: '6 ECTS', description: 'Network architectures, routing and switching protocols, design and hardening of communication infrastructures.' },
        { name: 'Distributed Systems', year: '1st year', term: '1st semester', cfu: '6 ECTS', description: 'Distributed systems: concurrency, consistency, fault tolerance, consensus algorithms and coordination between nodes.' },
        { name: 'Statistics', year: '1st year', term: '1st semester', cfu: '6 ECTS', description: 'Statistical and probabilistic methods applied to data analysis and quantitative risk assessment.' },
        { name: 'Elective course', year: '1st year', term: '1st semester', cfu: '12 ECTS', description: 'Free-choice course, to be defined in the study plan.' },
        { name: 'Cyber and Computer Law', year: '1st year', term: '2nd semester', cfu: '6 ECTS', description: 'IT law: personal data protection, computer crime, digital evidence and liability.' },
        { name: 'Ethical Hacking', year: '1st year', term: '2nd semester', cfu: '9 ECTS', description: 'Offensive techniques in a controlled environment: reconnaissance, vulnerability exploitation, post-exploitation and reporting.' },
        { name: 'Malware Analysis and Incident Forensics', year: '2nd year', term: '1st semester', cfu: '9 ECTS', description: 'Static and dynamic malware analysis, incident response and forensic acquisition of digital evidence.' },
        { name: 'Security Governance', year: '2nd year', term: '1st semester', cfu: '6 ECTS', description: 'Security governance: risk management, reference standards and frameworks, corporate policies and compliance.' },
        { name: 'Cyber Security Seminars', year: '2nd year', term: '2nd semester', cfu: '6 ECTS', description: 'A seminar series on advanced topics and real-world cases, held by researchers and industry professionals.' },
        { name: 'Final Thesis', year: '2nd year', term: '2nd semester', cfu: '30 ECTS', description: 'Master\'s thesis: original research work, with a written dissertation and final discussion.' },
      ],
